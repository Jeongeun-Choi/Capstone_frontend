...
const MakingTeam = () => {
  ...
  const submitResult = useCallback(() => {
    ...
    const data = { category, groupName, groupIntro };
  }, []);

  const changeTime = useCallback((time, timeString) => {
        ...
        >
          ...
          <main>
            <div className="team-name">
              ...
              <Select defaultValue="카테고리" onChange={changeCategory}>
